...
# Um die Funktion zu laden: 
source("Hier der Pfad des Verzeichnisses, in dem makepvalues.R gespeichert ist/makepvalues.R")

# jetzt einfach die Funktion benutzen:
makepvalues(gefittetesModell)
